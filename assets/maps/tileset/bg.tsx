...
<tileset version="1.10" tiledversion="1.12.2" name="bg" tilewidth="256" tileheight="386" tilecount="13" columns="0">
 ...
 <tile id="7">
  <image source="../gfx/tiles/bg/skulls.png" width="180" height="50"/>
 </tile>
 <tile id="8">
  <image source="../gfx/tiles/bg/chains3.png" width="200" height="265"/>
 </tile>
 <tile id="9">
  <image source="../gfx/tiles/bg/banner2.png" width="248" height="256"/>
 </tile>
 <tile id="15">
  <image source="../gfx/tiles/bg/banner4.png" width="256" height="270"/>
 </tile>
 <tile id="16">
  <image source="../gfx/tiles/bg/cage2.png" width="256" height="386"/>
 </tile>
 <tile id="17">
  <image source="../gfx/tiles/bg/banner5.png" width="256" height="269"/>
 </tile>
 <tile id="20">
  <image source="../gfx/tiles/bg/pole_skull.png" width="110" height="151"/>
 </tile>
 <tile id="22">
  <image source="../gfx/tiles/bg/chains4.png" width="124" height="192"/>
 </tile>
 <tile id="23">
